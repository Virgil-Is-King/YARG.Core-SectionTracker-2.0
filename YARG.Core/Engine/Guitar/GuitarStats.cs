...
using static YARG.Core.Engine.Guitar.GuitarStats.EnhancedGuitarStats;
...
=======
        ...
        public class EnhancedGuitarStats
        {
            ...
            public NoteTypesStorage TotalNoteStats = new();
            public NoteTypesStorage NoteHitStats = new();
            public NoteTypesStorage NoteMissStats = new();
